<%-- 
    Document   : ShowEnquiry
    Created on : 17-Oct-2023, 12:43:38 am
    Author     : hp
--%>
        ...
        <center>
            ...
            <table border="5px">
                ...
                <tr>
                    ...
                    <th colspan="10"><center>Show Enquiries</center></th>
                </tr>
                ...
                %>
                <tr>
                    <td><center><%=rs.getString("enquiry_id")%></center></td>
                    <td><center><%=rs.getString("name")%></center></td>
                    <td><center><%=rs.getString("email")%></center></td>
                    <td><center><%=rs.getString("message")%></center></td>
                </tr>
                <%
                    }
                %>
