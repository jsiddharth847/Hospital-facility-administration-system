<%-- 
    Document   : index
    Created on : 11-Oct-2023, 12:54:57 am
    Author     : hp
--%>
...
<html lang="en">
    ...
    <body>
        ...
        <div id="header" style="background-color:#007C9D;">
            ...
            &nbsp;&nbsp;
            &nbsp;&nbsp;
            <a href="LoginPageUser.html">
                <button id="loginbutton" class="btnlogin">Login/Signup?</button>
            </a>
            &nbsp;&nbsp;
            &nbsp;&nbsp;
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            ...
                            <a class="dropdown-item" href="assuredsurgeryprice.html">SPAN Surgery-Assured Price </a>
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item">
                <img class="d-block w-100" src="sliderimg.png" alt="Second slide">
            </div>
            <div class="carousel-item">
    ...
    <!--<div class="cardunderslider">
      <div class="cardnearslider">
        <a href="#speciality" class="words"> <img src="bookappt_icon.svg" alt="">
          <h5>Book Appointment</h5>
        </a>
      </div>-->
  
    <!--<div class="cardnearslider">
      <a href=""> <img src="bookhelathcheck_icon.svg" alt="">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 mb-50">
                    <div class="footer-widget">
                        ...
                        <div class="subscribe-form">
                            <form action="uploadEnquiry.jsp" method="post">
